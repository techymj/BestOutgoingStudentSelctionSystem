      ...
      <section> <div id="main-content">
          <section> <div class="wrapper">
            ...
            <h2>BOS Selection System</h2></div></div><br>
                        <div class="centered">  <div class="text-center mt-5"><h3><?php echo "welcome"." ".$_SESSION['Uname'];?></h3></div></div><br><br><br>
	                  	  	          <div class="centered">
									  <table align="center" width="50" border="0" cellspacing="0" cellpadding="0">
									   <div class="text-center mt-5">
                                       <tr><td><a class="btn btn-success" href="personal.php" role="button">Personal details</a></td></tr>
									   <tr><tr><td></td></tr></tr>
									   
                                       <tr><td><a class="btn btn-primary" href="academic.php" role="button">Acadedmic Details</a></td></tr>
									   <tr><td></td></tr>
                                       <tr><td><a class="btn btn-danger" href="Activities.php" role="button">Activities Details</a></td></tr>
                                       </div>
									   </table>
									   </div>
							</div>
