...
<html lang="en">
  <head>
    ...
    <title>Admin | List Of Participants</title>
      ...
      <section id="main-content">
          <section class="wrapper">
            ...
            <h2>BOS Selection System</h2></div></div><br>
                          ...
                          <div class="text-center mt-5"><h3>List of Applicants</h3></div>
                    ...
                    <i class="fa fa-arrow-circle-left"></i>
                      ...
                      <a href="round2.php?year=<?php echo $year?>">
                    <i class="fa fa-arrow-circle-right"></i>
                      ...
                      <table align="center" class="table table-striped table-advance table-hover table-dark table-bordered">
                              ...
                              <tbody>
                              <?php $ret=mysqli_query($conn,"SELECT * FROM `users2` where Submit_status='submitted' AND acyear='".$_GET['year']."'");
							                $cnt=1;
							                while($row=mysqli_fetch_array($ret))
							                 {
                                 $sname=$row['Name'];
                                 $sql=mysqli_query($conn,"SELECT * from personaldetails where sname='$sname'");
                              ...
                              <tr>
                                    ...
                                    <td>
                                      <a href="form.php?sname=<?php echo $row['Name'];?>">
                                       <button class="btn btn-primary ">VIEW</button>
                                       <?php
                                       //use table users
                                      // $sql1=mysqli_query($conn,"select * from users where Name='$sname'");
                                       // $run1=musqli_fetch_array($sql1);
                                      $calstatus=$row['calstatus'];
                                      
                                      
                                       if($calstatus=='pending'){?>
                                        <a href="includes/cal.php?sname=<?php echo $row['Name'];?>">
                                     ...
                                     <?php }?>
                                       ...
                                       <?php
                                          ...
                                          if($status=='pending'){?>
                                          <a href="includes/accept.php?sname=<?php echo $row['Name'];?>"> 
